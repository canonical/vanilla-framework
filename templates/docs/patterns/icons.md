...
A further set of icons are available, and need to be explicitly imported using `@include vf-p-icons--additional`.
...
<section>
  <div class="p-strip is-shallow u-no-padding--top">
    ...
    <div class="row">
      ...
      <div class="p-card col-3 u-vertically-center" style="display: flex; align-item: center;">
        <i class="p-icon--tag" style="margin-right: 1rem; flex-shrink: 0;"></i>
      </div>
      <div class="p-card col-3 u-vertically-center" style="display: flex; align-item: center;">
...
The [additional](#additional) set of icons is not included in Vanilla by default, if you require them you can add them to your project using the below include.

```scss
@import 'patterns_icons';
@include vf-p-icons--additional;
```
