...
In some cases, there might be a good reason to break out of the constraints of a 12 column grid and allow content to bleed into the page margins. Vanilla provides a separate [layout](/docs/layouts/grid-breakout) for this purpose
